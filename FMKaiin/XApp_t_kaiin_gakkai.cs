...
namespace App
{
	...
	/// テーブル編集の際に使うクラスです。
	/// </summary>
	public partial class t_kaiin_gakkai : FieldProp
	{
		/// <summary>
		/// フィールド[Access 高速検索用]。
		/// </summary>
		...
		/// <summary>
		/// 所属学会ID。System.DBNull.Value の場合 null を示します。
		/// </summary>
		...
		public t_kaiin_gakkai(object o) : base(o) {}
		#endregion
		/// <summary>
		/// t_kaiin_gakkai 型の空テーブルを作成し、返します。
		/// </summary>
		/// <returns>t_kaiin_gakkai 型の空テーブル</returns>
		public static DataTable GetTable()
		{
			DataTable	dt = new DataTable("t_kaiin_gakkai");
