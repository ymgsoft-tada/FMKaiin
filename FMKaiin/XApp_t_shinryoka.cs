...
namespace App
{
	...
	/// テーブル編集の際に使うクラスです。
	/// </summary>
	public partial class t_shinryoka : FieldProp
	{
		/// <summary>
		/// フィールド[Access 高速検索用]。
		/// </summary>
		...
		/// <summary>
		/// 診療科ID。System.DBNull.Value の場合 null を示します。
		/// </summary>
		...
		/// フィールド[診療科コード]。
		/// </summary>
		public const string FSRK_Code = "SRK_Code";
		/// <summary>
		/// 診療科コード
		/// </summary>
		public int SRK_Code
		{
			get	{	return Cast.Int(row == null ? null : row[FSRK_Code]);	}
			set	{	_set(FSRK_Code, value);	}
		}
		
		/// <summary>
		/// 診療科コード。System.DBNull.Value の場合 null を示します。
		/// </summary>
		public int? SRK_Code_Null
		{
			get	{	if (row == null || row[FSRK_Code] == System.DBNull.Value) { return null; } else { return Cast.Int(row[FSRK_Code]); }	}
			set	{	_set(FSRK_Code, value);	}
		}
		...
		/// フィールド[診療科名称]。
		/// </summary>
		public const string FSRK_Name = "SRK_Name";
		/// <summary>
		/// 診療科名称
		/// </summary>
		public string SRK_Name
		{
			get	{	return Cast.String(row == null ? null : row[FSRK_Name]);	}
			set	{	_set(FSRK_Name, value);	}
		}
		
		/// <summary>
		/// 診療科名称。System.DBNull.Value の場合 null を示します。
		/// </summary>
		public string SRK_Name_Null
		{
			get	{	if (row == null || row[FSRK_Name] == System.DBNull.Value) { return null; } else { return Cast.String(row[FSRK_Name]); }	}
			set	{	_set(FSRK_Name, value);	}
		}
		...
		public t_shinryoka(object o) : base(o) {}
		#endregion
		/// <summary>
		/// t_shinryoka 型の空テーブルを作成し、返します。
		/// </summary>
		/// <returns>t_shinryoka 型の空テーブル</returns>
		public static DataTable GetTable()
		{
			DataTable	dt = new DataTable("t_shinryoka");
			...
			col = new DataColumn(FSRK_Code, typeof(int));
			dt.Columns.Add(col);
			
			col = new DataColumn(FSRK_Name, typeof(string));
