...
namespace App
{
	...
	public static class enumKbn
	{
		...
		/// eByosho に対応した辞書です。
		/// </summary>
		public static Dictionary<int, string> DByosho;
		/// <summary>
		/// eTaikai に対応した辞書です。
		/// </summary>
		public static Dictionary<int, string> DTaikai;
		...
		public static void InitEnumDictionary()
		{
			...
			DByosho = new Dictionary<int, string>();
			DByosho.Add((int)eByosho.None, "");
			DByosho.Add((int)eByosho.Ari, "有");
			DByosho.Add((int)eByosho.Nashi, "無");
			
			DTaikai = new Dictionary<int, string>();
			DTaikai.Add((int)eTaikai.None, "");
			DTaikai.Add((int)eTaikai.Kaiin, "会員");
			DTaikai.Add((int)eTaikai.Taikai, "退会");
		}
	}
}
