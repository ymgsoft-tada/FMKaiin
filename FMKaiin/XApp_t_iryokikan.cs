...
namespace App
{
	...
	public partial class t_iryokikan : FieldProp
	{
		...
		/// <summary>
		/// フィールド[病床有無 0/None/ 1/Ari/有 2/Nashi/無]。
		/// </summary>
		public const string FIRK_ByoshoUmu = "IRK_ByoshoUmu";
		/// <summary>
		/// 病床有無 0/None/ 1/Ari/有 2/Nashi/無
		/// </summary>
		...
		/// <summary>
		/// 病床有無 0/None/ 1/Ari/有 2/Nashi/無。System.DBNull.Value の場合 null を示します。
		/// </summary>
		...
		/// <summary>
		/// フィールド[退会区分 0/None/ 1/Kaiin/会員 2/Taikai/退会]。
		/// </summary>
		public const string FIRK_TaikaiKbn = "IRK_TaikaiKbn";
		/// <summary>
		/// 退会区分 0/None/ 1/Kaiin/会員 2/Taikai/退会
		/// </summary>
		...
		/// <summary>
		/// 退会区分 0/None/ 1/Kaiin/会員 2/Taikai/退会。System.DBNull.Value の場合 null を示します。
		/// </summary>
